module.exports = {
  ...
  $addField[✓ | Kayıt kanalı ayarlandı.;**Sıradaki Komutlar**
  ...
  $setServerVar[kkanal2;evet]
  $onlyIf[$mentionedChannels[1]!=;{description:**╳ | Bir kanal etiketlemelisin.**}{color:BLACK}]
