module.exports = {
  ...
  $onlyIf[$noMentionMessage!=;$customEmoji[yasak] Lütfen Bir Tavsiye Gir]
  $onlyIf[$getServerVar[tavsiyeyetkili]!=;<@$ownerID> Beyefendi/Hanımefendi Lütfen Tavsiye Yetkili Rolünu Ayarlayın]
  $onlyIf[$getServerVar[tavsiyelog]!=;<@$ownerID> Beyefendi/Hanımefendi Lütfen Tavsiye Logu Ayarlayın]
